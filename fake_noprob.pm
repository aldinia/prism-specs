...
t1: [1..3] init A1; // 1 believer, 2 susceptible, 3 fact checker
...
t2: [1..3] init A2; // 1 believer, 2 susceptible, 3 fact checker
...
t3: [1..3] init A3; // 1 believer, 2 susceptible, 3 fact checker
...
t5: [1..3] init A5; // 1 believer, 2 susceptible, 3 fact checker
...
t6: [1..3] init A6; // 1 believer, 2 susceptible, 3 fact checker
...
t7: [1..3] init A7; // 1 believer, 2 susceptible, 3 fact checker
...
t8: [1..3] init A8; // 1 believer, 2 susceptible, 3 fact checker
...
t9: [1..3] init A9; // 1 believer, 2 susceptible, 3 fact checker
...
t10: [1..3] init A10; // 1 believer, 2 susceptible, 3 fact checker
...
t26: [1..3] init 2; // 1 believer, 2 susceptible, 3 fact checker
...
t27: [1..3] init 2; // 1 believer, 2 susceptible, 3 fact checker
...
t28: [1..3] init 2; // 1 believer, 2 susceptible, 3 fact checker
...
t29: [1..3] init 2; // 1 believer, 2 susceptible, 3 fact checker
