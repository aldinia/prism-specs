...
t4: [0..3] init 3; // 1 believer, 2 susceptible, 3 fact checker
...
[go] t4=3 & (inner>0) -> (p):(ref4'=true) + (1-p):true;
...
t14: [0..3] init 3; // 1 believer, 2 susceptible, 3 fact checker
...
[go] t14=3 & (middle>0) -> (q):(ref14'=true) + (1-q):true;
...
[go] t19=2 & check_upper -> (acc19'=false)&(ref19'=true)&(t19'=2);
