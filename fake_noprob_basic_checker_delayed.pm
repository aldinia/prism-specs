...
t4: [1..4] init A4; // 1 believer, 2 susceptible, 3 fact checker
...
[go] t4=3 -> (t4'=4);
[go] t4=4 & (inner>0) -> (t4'=3) & (ref4'=true);
[go] t4=4 & (inner=0) ->  (t4'=3);
...
[go] t5=2 & check_inner -> (acc5'=false) & (ref5'=true);
[go] t5=2 & !check_inner & (inner>2) ->  (acc5'=true);
[go] t5=2 & !check_inner & !(inner>2) ->  true;
...
[go] t12=2 & check_middle -> (acc12'=false) & (ref12'=true);
[go] t12=2 & !check_middle & ((middle + (acc4 ? 1 : 0)) > 2) ->  (acc12'=true);
[go] t12=2 & !check_middle & !((middle + (acc4 ? 1 : 0)) > 2) ->  true;
...
[go] t13=2 & check_middle -> (acc13'=false) & (ref13'=true);
[go] t13=2 & !check_middle & middle>2 ->  (acc13'=true);
[go] t13=2 & !check_middle & !(middle>2) ->  true;
...
t14: [1..4] init A14; // 1 believer, 2 susceptible, 3 fact checker
...
[go] t14=3 -> (t14'=4);
[go] t14=4 & (middle>0) -> (t14'=3) & (ref14'=true);
[go] t14=4 & (middle=0) -> (t14'=3);
...
[go] t17=2 & check_upper -> (acc17'=false) & (ref17'=true);
[go] t17=2 & !check_upper & upper>2 ->  (acc17'=true);
[go] t17=2 & !check_upper & !(upper>2) ->  true;
...
[go] t18=2 & check_upper -> (acc18'=false) & (ref18'=true);
[go] t18=2 & !check_upper & ((upper + (acc7 ? 1 : 0)) > 2)  ->  (acc18'=true);
[go] t18=2 & !check_upper & !((upper + (acc7 ? 1 : 0)) > 2) ->  true;
...
[go] t19=2 & check_upper -> (acc19'=false) & (ref19'=true);
[go] t19=2 & !check_upper & upper>2 ->  (acc19'=true);
[go] t19=2 & !check_upper & !(upper>2) ->  true;
...
t32: [1..4] init A32; // 1 believer, 2 susceptible, 3 fact checker
...
[go] t32=3 -> (t32'=4);
[go] t32=4 & (upper>0) -> (t32'=3) & (ref32'=true);
[go] t32=4 & (upper=0) -> (t32'=3);
endmodule
